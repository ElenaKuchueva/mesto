...
сards.forEach(function(createCard) {
...
console.log(addPopupInputNewPlace);
console.log(addPopupInputLink);
evt.preventDefault();
addNewCard(
...
closeImageButton = document.querySelector('.popup__close_full-image');
